## PHP CLI dockerfile
This repository contains **Dockerfile** of PHP7 CLI Docker's [automated build](https://hub.docker.com/r/xaamin/php-cli)
...
### Usage
```
	docker run --rm -it xaamin/php-cli:7.2 bash
```