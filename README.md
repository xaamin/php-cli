## PHP CLI dockerfile
This repository contains **Dockerfile** of PHP7.0 CLI Docker's [automated build](https://hub.docker.com/r/xaamin/php-cli)
...
### Usage
```
	docker run --rm -it xaamin/php-cli:7.0 bash
```